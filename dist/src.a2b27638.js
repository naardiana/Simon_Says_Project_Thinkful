 ...
 * DOM SELECTORS
 */
var startButton = document.querySelector(".js-start-button"); // TODO: Add the missing query selectors:
...
padContainer.addEventListener("click", padHandler); // TODO: Add an event listener `startButtonHandler()` to startButton.
...
function padHandler(event) {
  ...
  if (!color) return; // TODO: Write your code here.
...
function playComputerTurn() {
  ...
  var randomColor = getRandomItem(["red", "green", "blue", "yellow"]);
...
function playHumanTurn() {
  ...
  setText(statusSpan, "Press the pads (".concat(computerSequence.length - playerSequence.length, " left)"));
}
/**
...
function checkPress(color) {
  ...
  if (playerSequence.length === computerSequence.length) {
    ...
    setText(statusSpan, "Presses left: ".concat(computerSequence.length - playerSequence.length));
  }
}
/**
